document.addEventListener('DOMContentLoaded', function() {
    ...
    const footerItems = document.querySelectorAll('footer element');
    let currentIndex = 3;
    ...
    function updateMainContent(index) {
        const mainContent = [
            ...
            },
            {
                ...
                date: "Jan 12",
                description: "Your participation in the TPM Check is .......",
        ...
        document.querySelector('date').innerHTML = `<i class="fa fa-calendar"></i> ${content.date}`;
